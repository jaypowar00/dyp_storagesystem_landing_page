...
function App() {
    return (
        <div className="App" >
            <div className='title'>
                <img src={dyp_logo} alt='logo' style={{width: '50vw', maxWidth: '400px'}} />
            </div>
            <div className='content text-center'>
                ...
                <div className="content-center">
                    <AwesomeButton type="primary" ripple href="http://10.10.1.20:8086" size="large" >Get Started</AwesomeButton>
                </div>
